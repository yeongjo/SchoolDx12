...
public:
	...
	virtual void OnPrepare(ID3D12GraphicsCommandList *pd3dCommandList, int nPipelineState = 0);
	...
	void SetPipelineState(ID3D12GraphicsCommandList* pd3dCommandList, int nPipelineState=0);
private:
...
public:
	...
	void OnPrepare(ID3D12GraphicsCommandList* pd3dCommandList, int nPipelineState = 0);
};
/////////////////////////////////////////////////////////////////////////////////////
//
